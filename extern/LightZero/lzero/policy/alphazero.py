...
class AlphaZeroPolicy(Policy):
    ...
    def _get_simulation_env(self):
        ...
        elif self._cfg.simulation_env_id == 'suika':
            from zoo.suika.envs.suika_env import SuikaEnv
            from zoo.suika.config.suika_sampled_alphazero_config import suika_alphazero_config
            self.simulate_env = SuikaEnv(suika_alphazero_config.env)
        else:
            raise NotImplementedError
